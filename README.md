...
| v0.6 Repo Intelligence Graph | 部分实现 | 起步目标是 repo map、基础符号提取、symbol search 和 context builder；完整 Tree-sitter、SQLite 索引和影响面分析仍未完成。 |

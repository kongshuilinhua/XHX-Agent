...
class FileHistory:
    """Tracks file modification history for a session, enabling rewind.

    Creates backup copies of files before edits, maintains snapshots
    tied to conversation turns, and supports rewinding to any snapshot.
    """

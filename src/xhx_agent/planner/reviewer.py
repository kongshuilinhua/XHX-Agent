    ...
    def review(self, task: str, changed_files: list[str], verification_results: list[TerminalResult]) -> ReviewDecision:
        ...
        if changed_files and not verification_results:
            return ReviewDecision(
                passed=False, reason="Changed files were not verified by any commands.", needs_replan=True
            )
        ...
        return ReviewDecision(passed=True, reason="All changes verified successfully with zero errors.")
